...
/**
 * @brief A string constant representing the prompt for entering a product price.
 *
 * This constant is used to request the user to input the price of a product in euros.
 */
#define GET_PRODUCT_PRICE "Enter Product Price(euros): "
