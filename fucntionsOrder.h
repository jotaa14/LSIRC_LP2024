...
/**
 * @brief Updates the total purchased products for an order.
 *
 * This function recalculates and updates the total quantity of purchased products 
 * for a given order.
 *
 * @param management - A pointer to the management structure containing the order.
 * @param id - The ID of the order to update the total purchased products.
 */
...
/**
 * @brief Reduces the product quantity used by an order.
 *
 * This function reduces the quantity of a product used by a specific order.
 *
 * @param order - A pointer to the order to update the product usage.
 */
...
/**
 * @brief Lists orders filtered by the processes associated with them.
 *
 * This function organizes and displays orders based on their related processes.
 *
 * @param management - A pointer to the management structure containing the orders.
 */
