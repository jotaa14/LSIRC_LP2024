...
/**
 * @brief A constant representing the maximum size of a customer's district name.
 *
 * This constant defines the maximum length for a customer's district name (100 characters).
 */
#define CUSTOMER_DISTRICT_SIZE 100

/**
 * @brief A constant representing the maximum size of a customer's city name.
 *
 * This constant defines the maximum length for a customer's city name (100 characters).
 */
#define CUSTOMER_CITY_SIZE 100

/**
 * @brief A constant representing the maximum size of a customer's street name.
 *
 * This constant defines the maximum length for a customer's street name (100 characters).
 */
#define CUSTOMER_STREET_SIZE 100
