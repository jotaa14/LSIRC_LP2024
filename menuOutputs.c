...
void OrderListMenuOuput() {
    ...
    puts(ORDER_LIST_MENU_PROCESS);
    puts(EXIT);
    puts(MENU_BOTTOM);
    puts(MENU_OPTION);
}
void OrderListMenuProcessOuput(){
    puts(ORDER_LSIT_PROCESS_HEADER);
    puts(ORDER_LSIT_PROCESS_STATUS);
    puts(ORDER_LSIT_PROCESS_FULFILLMENT);
    puts(ORDER_LSIT_PROCESS_DATE);
    puts(ORDER_LSIT_PROCESS_OBSERVATION);
    puts(EXIT);
    puts(MENU_BOTTOM);
    puts(MENU_OPTION);
}
