...
/**
 * @brief A string constant for displaying the observation of an order.
 *
 * This format string is used to display the observation details of a specific order.
 */
#define ORDER_OBSERVATION "Order Observation: %s\n"
...
/**
 * @brief A string constant for listing orders by fulfillment percentage.
 *
 * This option is displayed in the menu when the user wants to list orders based on their fulfillment percentage.
 */
#define ORDER_LIST_MENU_FULFILLMENT "| 6-List Orders By Fulfillment   |"
 ...
 */
#define ORDER_LIST_STUFF_OBSERVATION "Enter the observation for order:"
